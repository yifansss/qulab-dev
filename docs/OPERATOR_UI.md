...
- 还没有完整的 live compute/derived data selector；规划见 `docs/LIVE_COMPUTE_DERIVED_DATA_PLAN.md`。后续 Live Run page 应能选择 raw/derived keys、显示 module 状态，并只负责展示，不负责具体公式。
